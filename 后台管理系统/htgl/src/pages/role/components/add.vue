    ...
    <el-dialog :title="info.title" :visible.sync="info.show">
      <el-form :model="form">
        ...
        <el-form-item label="角色权限" label-width="80px">
          ...
          <el-tree :data="menuList" show-checkbox node-key="id" :props="defaultProps" ref="tree" :default-checked-keys="defaultKey"></el-tree>
        </el-form-item>

        <el-form-item label="角色状态" label-width="80px">
          <el-switch v-model="form.status" :active-value="1" :invalid-value="2"></el-switch>
        </el-form-item>
      </el-form>
...
export default {
  ...
  mounted() {
    //如果之前menu的list没有请求,就发请求,请求过了就不发了
